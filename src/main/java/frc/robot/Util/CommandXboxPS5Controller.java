...
public class CommandXboxPS5Controller extends CommandGenericHID {
     ...
     *
     * @return an event instance representing the A button's digital signal attached to the {@link CommandScheduler#getDefaultButtonLoop()
     ...
     *
     * @return an event instance representing the B button's digital signal attached to the {@link CommandScheduler#getDefaultButtonLoop()
     *         default scheduler button loop}.
     * @see #b(EventLoop)
     */
    public Trigger b() {
     ...
     *
     * @return an event instance representing the X button's digital signal attached to the {@link CommandScheduler#getDefaultButtonLoop()
     *         default scheduler button loop}.
     * @see #x(EventLoop)
     */
    public Trigger x() {
     ...
     *
     * @return an event instance representing the Y button's digital signal attached to the {@link CommandScheduler#getDefaultButtonLoop()
     *         default scheduler button loop}.
     * @see #y(EventLoop)
     */
    public Trigger y() {
    ...
    /**
     * Constructs a Trigger instance around the axis value of the left trigger. The returned trigger will be true when the axis value is
     * greater than {@code threshold}.
     *
     * @param threshold the minimum axis value for the returned {@link Trigger} to be true. This value should be in the range [0, 1] where 0
     *                  is the unpressed state of the axis.
     * @param loop      the event loop instance to attach the Trigger to.
     * @return a Trigger instance that is true when the left trigger's axis exceeds the provided threshold, attached to the given event loop
     */
     ...
     * @param threshold the minimum axis value for the returned {@link Trigger} to be true. This value should be in the range [0, 1] where 0
     *                  is the unpressed state of the axis.
     * @return a Trigger instance that is true when the left trigger's axis exceeds the provided threshold, attached to the
     *         {@link CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
     */
    ...
    /**
     * Constructs a Trigger instance around the axis value of the right trigger. The returned trigger will be true when the axis value is
     * greater than {@code threshold}.
     *
     * @param threshold the minimum axis value for the returned {@link Trigger} to be true. This value should be in the range [0, 1] where 0
     *                  is the unpressed state of the axis.
     * @param loop      the event loop instance to attach the Trigger to.
     * @return a Trigger instance that is true when the right trigger's axis exceeds the provided threshold, attached to the given event
     *         loop
     */
     ...
     * @param threshold the minimum axis value for the returned {@link Trigger} to be true. This value should be in the range [0, 1] where 0
     *                  is the unpressed state of the axis.
     * @return a Trigger instance that is true when the right trigger's axis exceeds the provided threshold, attached to the
     *         {@link CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
     */
    ...
    /**
     * Get the left trigger (LT) axis value of the controller. Note that this axis is bound to the range of [0, 1] as opposed to the usual
     * [-1, 1].
     *
     * @return The axis value.
     */
    ...
    /**
     * Get the right trigger (RT) axis value of the controller. Note that this axis is bound to the range of [0, 1] as opposed to the usual
     * [-1, 1].
     *
     * @return The axis value.
     */
