...
public class autoShoot extends Command {
  ...
  public autoShoot(CommandSwerveDrivetrain drivetrain, StageSubsystem stage, DoubleSupplier ARMPALCEHOLDER, ShooterSubsystem shooter) {
  ...
  public void execute() {
    ...
    if (m_stage.isNoteInStage()) {
        ...
        } else if (dist > Constants.ShooterConstants.subwooferRangeMin && dist < Constants.ShooterConstants.subwooferRangeMax) {
            // arm to sub shot pos
        }
